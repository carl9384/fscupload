...
if os.getcwd().split("/")[-1] == "ThreeDFSCprog":
    from ThreeDFSC import ThreeDFSC_ReleaseAug2017
    from ThreeDFSC import ThreeDFSC_Analysis_V3
else:
    from ThreeDFSCprog.ThreeDFSC import ThreeDFSC_ReleaseAug2017
    from ThreeDFSCprog.ThreeDFSC import ThreeDFSC_Analysis_V3

start_time = time.time()

# Check Anaconda version
if (sys.version[0] != '3'):
	print ("\n\033[1;31;40mAnaconda 3 is required to run this program. Please install it and use the correct Python to execute the 3DFSC program. \033[0;37;40m")
	print ("\nYour version of Python is %s \n" % sys.version)
	sys.exit()
elif ('conda' in sys.version == False):
	print ("\n\033[1;31;40mAnaconda 3 is required to run this program. Please install it and use the correct Python to execute the 3DFSC program. \033[0;37;40m")
	print ("\nYour version of Python is %s \n" % sys.version)
	sys.exit()
